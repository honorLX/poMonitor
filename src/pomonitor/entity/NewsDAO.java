...
public class NewsDAO  implements INewsDAO{
	...
	private EntityManager getEntityManager() {
		...
		/**
	 Perform an initial save of a previously unsaved News entity. 
	 ...
	 * </pre>
	   @param entity News entity to persist
	 ...
	 *   entity = null;
	 * </pre>
	   @param entity News entity to delete
	 @throws RuntimeException when the operation fails
	 */
    public void delete(News entity) {
    				EntityManagerHelper.log("deleting News instance", Level.INFO, null);
	        try {
        	entity = getEntityManager().getReference(News.class, entity.getRelId());
    ...
    /**
	 Persist a previously saved News entity and return it or a copy of it to the sender. 
	 A copy of the News entity parameter is returned when the JPA persistence mechanism has not previously been tracking the updated entity. 
	 ...
	 *   EntityManagerHelper.commit();
	 * </pre>
	   @param entity News entity to update
    ...
    public News findById( Integer id) {
    				EntityManagerHelper.log("finding News instance with id: " + id, Level.INFO, null);
	        try {
...
/**
    ...
    public List<News> findByProperty(String propertyName, final Object value
    				...
    				EntityManagerHelper.log("finding News instance with property: " + propertyName + ", value: " + value, Level.INFO, null);
			try {
