...
public class News  implements java.io.Serializable {
	...
	/** minimal constructor */
    public News(Integer relId, String id, String title, String url, String content, String web, String time, String allContent, Integer failedCount, Integer isFinsh, Integer isFailed, Integer isWorking) {
        this.relId = relId;
        this.id = id;
        this.title = title;
        this.url = url;
    ...
    /** full constructor */
    public News(Integer relId, String id, String title, String url, String content, String web, String time, String allContent, String keyWords, String contentPath, Integer failedCount, Integer isFinsh, Integer isFailed, Integer isWorking) {
        this.relId = relId;
        this.id = id;
        this.title = title;
        this.url = url;
