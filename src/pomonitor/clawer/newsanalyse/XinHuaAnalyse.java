...
try {
			...
			Elements listEle= doc.getElementsByAttributeValue("class", "toolTab_xgxwts");
	...
	public HashMap<String, Object> analyseAnyPage(String Strurl) {
		...
		try {
			...
			//抽取块内容
			Elements listEle= listEle2.getElementsByAttributeValueContaining("class", "reIte");
			for(Element e:listEle){
			    ...
			    //得到time和web
			    Elements timeE=e.getElementsByAttributeValue("class", "snapshot");
