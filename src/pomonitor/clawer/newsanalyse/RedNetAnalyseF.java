...
public class RedNetAnalyseF extends BaseAnalyse {
	...
	public int getPageCount(String key,boolean isLatest) {
		...
		try {
			...
			//获取搜索结果数量字符串
			Elements listEle= doc.getElementsByAttributeValue("class", "bold-font");
	...
	public HashMap<String, Object> analyseAnyPage(String Strurl) {
		...
		try {
			...
			//获取每一条
			Elements listEle= doc.getElementsByAttributeValue("class", "module");
			...
			for(Element e:listEle){
				...
				//获取title
				Elements titleE=e.getElementsByAttributeValue("class", "title");
				...
				//获取content
				Elements contentE=e.getElementsByAttributeValue("class", "content");
